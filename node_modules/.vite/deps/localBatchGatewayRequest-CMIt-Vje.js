import { n as keccak_256, t as init_sha3 } from "./sha3-B6-sXyeu.js";
...
var hexes$2 = /*#__PURE__*/ Array.from({ length: 256 }, (_v, i) => i.toString(16).padStart(2, "0"));
/**
...
function bytesToHex$1(value, opts = {}) {
	let string = "";
	for (let i = 0; i < value.length; i++) string += hexes$2[value[i]];
	const hex = `0x${string}`;
	if (typeof opts.size === "number") {
		assertSize$2(hex, { size: opts.size });
		return pad$2(hex, {
...
function stringToHex(value_, opts = {}) {
	return bytesToHex$1(encoder$3.encode(value_), opts);
}
//#endregion
...
function numberToBytes(value, opts) {
	return hexToBytes$1(numberToHex(value, opts));
}
/**
...
function encodeString(value) {
	...
	return {
		dynamic: true,
		encoded: concat$1([padHex(numberToHex(size$2(hexValue), { size: 32 })), ...parts])
	};
}
...
async function call(client, args) {
	...
	try {
		...
		const { offchainLookup, offchainLookupSignature } = await import("./ccip-CNp9J4xN.js");
...
//#endregion
export { bytesToNumberBE as $, hexToBool as $n, UserRejectedRequestError as $t, padLeft as A, getAbiItem as An, BundleTooLargeError as At, slice$1 as B, getAddress as Bn, MethodNotSupportedRpcError as Bt, IntegerOutOfRangeError as C, stringify$1 as Cn, getNodeError as Ct, fromBytes as D, PositionOutOfBoundsError as Dn, UnknownNodeError as Dt, fromBoolean as E, createCursor as En, TipAboveFeeCapError as Et, validate as F, sliceHex as Fn, InvalidParamsRpcError as Ft, trimLeft as G, hexToBytes$1 as Gn, SwitchChainError as Gt, toBoolean as H, InvalidAddressError as Hn, ProviderDisconnectedError as Ht, from$1 as I, concat$1 as In, InvalidRequestRpcError as It, aInRange as J, bytesToHex$1 as Jn, UnknownBundleIdError as Jt, stringify as K, stringToBytes as Kn, TransactionRejectedRpcError as Kt, fromHex as L, concatHex as Ln, JsonRpcVersionUnsupportedError as Lt, size as M, bytesRegex as Mn, DuplicateIdError as Mt, slice as N, integerRegex as Nn, InternalRpcError as Nt, fromNumber as O, encodeFunctionData as On, AtomicReadyWalletRejectedUpgradeError as Ot, toNumber as P, slice$2 as Pn, InvalidInputRpcError as Pt, bytesToHex as Q, hexToBigInt as Qn, UnsupportedProviderMethodError as Qt, fromString$1 as R, isAddress as Rn, LimitExceededRpcError as Rt, toRpc as S, formatEther as Sn, extract as St, from as T, decodeAbiParameters as Tn, FeeCapTooHighError as Tt, toNumber$1 as U, toEventSelector as Un, ResourceNotFoundRpcError as Ut, toBigInt$1 as V, LruMap as Vn, ParseRpcError as Vt, toString as W, keccak256 as Wn, ResourceUnavailableRpcError as Wt, bitLen as X, stringToHex as Xn, UnsupportedChainIdError as Xt, abool as Y, numberToHex as Yn, UnknownRpcError as Yt, bitMask as Z, toHex as Zn, UnsupportedNonOptionalCapabilityError as Zt, erc6492SignatureValidatorAbi as _, TransactionReceiptNotFoundError as _n, maxUint256 as _t, withResolvers as a, ContractFunctionExecutionError as an, AbiEventNotFoundError as ar, inRange as at, universalResolverResolveAbi as b, prettyPrint as bn, formatTransactionRequest as bt, encodeDeployData as c, RawContractError as cn, BytesSizeMismatchError as cr, numberToBytesBE as ct, InvalidChainIdError as d, isAbortError as dn, BaseError$1 as dr, validateObject as dt, WalletConnectSessionSettlementError as en, hexToNumber$1 as er, bytesToNumberLE as et, deploylessCallViaBytecodeBytecode as f, InvalidLegacyVError as fn, size$2 as fr, decodeFunctionResult as ft, erc1271Abi as g, TransactionNotFoundError as gn, maxUint16 as gt, addressResolverAbi as h, TransactionExecutionError as hn, parseAbi as hr, assertRequest as ht, createBatchScheduler as i, CallExecutionError as in, AbiDecodingZeroDataError as ir, hexToBytes as it, padRight as j, encodeAbiParameters as jn, ChainDisconnectedError as jt, fromString as k, parseAccount as kn, AtomicityNotSupportedError as kt, ChainMismatchError as l, getAbortError as ln, DecodeLogDataMismatch as lr, numberToBytesLE as lt, multicall3Bytecode as m, InvalidStorageKeySizeError as mn, formatAbiItem as mr, formatBlockParameter as mt, localBatchGatewayUrl as n, RpcRequestError as nn, pad$2 as nr, createHmacDrbg as nt, getCallError as o, ContractFunctionRevertedError as on, AbiEventSignatureEmptyTopicsError as or, isBytes as ot, erc6492SignatureValidatorByteCode as p, InvalidSerializableTransactionError as pn, isHex as pr, isAddressEqual as pt, BaseError as q, toBytes as qn, UnauthorizedProviderError as qt, call as r, TimeoutError as rn, AbiDecodingDataSizeTooSmallError as rr, ensureBytes as rt, getChainContractAddress as s, ContractFunctionZeroDataError as sn, AbiEventSignatureNotFoundError as sr, memoized as st, localBatchGatewayRequest as t, HttpRequestError as tn, trim$1 as tr, concatBytes as tt, ChainNotFoundError as u, getUrl as un, DecodeLogTopicsMismatch as ur, numberToHexUnpadded as ut, multicall3Abi as v, TransactionReceiptRevertedError as vn, serializeStateOverride as vt, concat as w, decodeErrorResult as wn, ExecutionRevertedError as wt, universalResolverReverseAbi as x, formatGwei as xn, defineFormatter as xt, textResolverAbi as y, WaitForTransactionReceiptTimeoutError as yn, defineTransactionRequest as yt, size$1 as z, checksumAddress as zn, MethodNotFoundRpcError as zt };

//# sourceMappingURL=localBatchGatewayRequest-CMIt-Vje.js.map